<div class="menu__base">
    <ul class="menu__base--list">
        <li class="menu__base--item">
            <a href="/" title="Back to Hompage"><i class="fas fa-home"></i></a>
        </li>
        <li class="menu__base--item">
        ...
        <li class="menu__base--item">
            <a href="/admin/?type=user" title="Edit Users"><i class="fas fa-users"></i></a>
        </li>
        <li class="menu__base--item">
